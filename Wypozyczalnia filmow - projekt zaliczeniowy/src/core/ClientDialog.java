...
public class ClientDialog extends JDialog implements WindowObject<Client> {
	...
	private JTextField firstNameText = new JTextField("Jan");
	private JTextField secondNameText = new JTextField("Kowalski");
	...
	private void initialize() {
		...
		{
			JLabel firstNameLabel = new JLabel("Imie:");
		...
		{
			JLabel lblNewLabel_1 = new JLabel("Utworzony w dniu:");

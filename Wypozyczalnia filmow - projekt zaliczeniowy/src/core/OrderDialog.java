...
public class OrderDialog extends JDialog implements WindowObject<Order> {
	...
	public static void main(String[] args) {
		try {
			OrderDialog dialog = new OrderDialog(new JFrame(), "Tytul");
	...
	private void initialize() {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			contentPanel.add(tabbedPane, BorderLayout.NORTH);
			{
				...
				tabbedPane.addTab("Zamowienie", null, panel, null);
				panel.setLayout(new GridLayout(0, 2, 0, 0));
				{
					JLabel createdOnLabel = new JLabel("Utworzony w dniu: ");
				...
				{
					JLabel lblNewLabel = new JLabel("Zwrocony w dniu: ");
			...
			}
			{
				...
				tabbedPane.addTab("Filmy", null, entriesPanel, null);
				...
				JButton btnRemove = new JButton("Usun zaznaczone");
			...
			{
				JPanel entriesPanel = new JPanel();
				tabbedPane.addTab("Klient", null, entriesPanel, null);
				entriesPanel.setLayout(new BorderLayout(0, 0));
